...
/**
 * mpz_sqrt_ceil - Get the square root of a number.
 * 
 * @result: where the mpz_sqrt_ceil result is stored.
...
/**
 * fermat_factorization - an ancient algorithm for factoring
 * composite integers.
 * 
 * @n: Number to factorize
 * @factors: where the factors (x,y) results are stored.
 * 
 * Result: Nothing
*/
